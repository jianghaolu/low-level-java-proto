...
public class EntitiesLinkingDynamicRequest extends DynamicRequest {
    public EntitiesLinkingDynamicRequest(SerializerAdapter serializerAdapter, HttpPipeline httpPipeline) {
    ...
    public EntitiesLinkingDynamicResponse send() {
        return new EntitiesLinkingDynamicResponse(getSerializerAdapter(), getHttpPipeline().send(buildRequest(), getContext()));
    }
