...
public final class TextAnalyticsClientBuilder {
     ...
     * @return the TextAnalyticsClientBuilder.
     */
    public TextAnalyticsClientBuilder credential(AzureKeyCredential azureKeyCredential) {
    ...
    /**
     * Builds an instance of TextAnalyticsAsyncClient async client.
     *
     * @return an instance of TextAnalyticsAsyncClient.
     */
    public TextAnalyticsAsyncClient buildAsyncClient() {
        return new TextAnalyticsAsyncClient(buildInnerClient());
    }

    /**
     * Builds an instance of TextAnalyticsClient sync client.
     *
     * @return an instance of TextAnalyticsClient.
     */
    public TextAnalyticsClient buildClient() {
        return new TextAnalyticsClient(buildInnerClient());
    }
}
