...
@ServiceClient(builder = AnomalyDetectorLowLevelClientBuilder.class, isAsync = true)
public final class AnomalyDetectorLowLevelClient {
    private final AnomalyDetectorLowLevelClientImpl serviceClient;
     ...
     */
    AnomalyDetectorLowLevelClient(AnomalyDetectorLowLevelClientImpl serviceClient) {
    ...
    public Mono<Response<String>> detectEntireSeriesWithResponse(String body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<String> detectEntireSeries(String body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<String>> detectLastPointWithResponse(String body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<String> detectLastPoint(String body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<String>> detectChangePointWithResponse(String body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<String> detectChangePoint(String body) {
